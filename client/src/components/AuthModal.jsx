		...
		<div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
			<div className="bg-white rounded-lg p-8 max-w-md w-full">
				...
				<div className="mt-4 text-center">
					...
					>
						{isLogin 
							? <p className="">Нет аккаунта?<span className="underline text-cyan-900 px-2">Зарегистрируйтесь</span></p> 
							: <p className="">Уже есть аккаунт?<span className="underline text-cyan-900 px-2">Войдите</span></p>}
					</button>
				</div>
			</div>
		</div>
